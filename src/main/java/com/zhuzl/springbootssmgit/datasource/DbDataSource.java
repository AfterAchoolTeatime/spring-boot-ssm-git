package com.zhuzl.springbootssmgit.datasource;
...
@Configuration
@MapperScan(basePackages = "com.zhuzl.springbootssmgit.dao",sqlSessionTemplateRef = "dbSqlSessionTemplate")
public class DbDataSource {

    @Bean(name="dbData")
    @ConfigurationProperties(prefix = "spring.datasource")
    public javax.sql.DataSource dbDataSource() {
